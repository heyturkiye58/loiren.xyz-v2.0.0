export default function Hero() {
    return (
        <div className="pb-5 overflow-hidden flex items-end -skew-y-3 -translate-y-1/3 -z-[1] absolute top-0 left-0 right-0 h-[275px] md:h-[375px]" style={{ backgroundImage: 'url(https://cdn.feign-wiki.tk/img/adeninkonas.jpg)', backgroundSize: 'cover' }}>
