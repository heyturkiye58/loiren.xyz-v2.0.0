        ...
        <div className="hidden md:block -skew-y-3 mt-24 rounded-lg w-full h-[140px] sm:gap-x-6 py-5 relative">
            ...
            <p onClick={() => {
                ...
                if(_currentTheme === 'link1') {
                    ...
                    document.getElementById('iframe-id').setAttribute('src', 'https://linkcord.js.org/api/v3/widget/849166079553175582?type=vsc&language=en&theme=dark&background=#02040A');
                } else {
                    localStorage.setItem('links', 'link1');
                    document.getElementById('iframe-id').setAttribute('src', 'https://linkcord.js.org/api/v3/widget/849166079553175582?type=spotify_large&language=en&theme=dark&background=#02040A');
                }
                }} 
                ...
                <iframe id="iframe-id" src="https://linkcord.js.org/api/v3/widget/849166079553175582?type=spotify_large&language=en&theme=dark&background=#02040A" className="w-full" height="140" frameBorder="0" />
            </div>}
        </div>
    );
};
